ig.module(
    ...
    .defines(function(){
        EntityPlayer2 = ig.Entity.extend({
            animSheet: new ig.AnimationSheet( 'media/topme.png', 16, 16 ),
            size: {x: 8, y:14},
            offset: {x: 4, y: 2},
            flip: false,
            maxVel: {x: 100, y: 100},
            ...
            setupAnimation: function(offset){
                ...
                this.addAnim('run', .02, [0 ,1 ,2 ,3 ,4 , 5]);
                this.addAnim('fall', 1, [0 ,1 ,2 ,3 ,4 , 5]);
                this.addAnim('jump', 0.4, [0 ,1 ,2 ,3 ,4 , 5]);
                this.addAnim('swim',.07, [0 ,1 ,2 ,3 ,4 , 5]);
            },
            ...
            update: function() {
                ...
                }else if( ig.input.pressed('left') || ig.input.pressed('right')) {
                    this.currentAnim = this.anims.run;
                }else{
            ...
            onDeath: function(){
                ...
                if(ig.game.lives < 0){
                    ...
                    ig.game.spawnEntity( EntityPlayer2, ig.game.respawnPosition.x, ig.game.respawnPosition.y);
                }
            },
