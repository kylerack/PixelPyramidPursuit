...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet( 'media/me2.png', 16, 16 ),
        size: {x: 8, y:14},
        offset: {x: 4, y: 2},
        flip: false,
        maxVel: {x: 100, y: 150},
        ...
        jumpSFX: new ig.Sound( 'media/sounds/Jump2.*' ),
        shootSFX: new ig.Sound( 'media/sounds/Shoot2.*' ),
        deathSFX: new ig.Sound( 'media/sounds/Death2.*' ),
        ...
        setupAnimation: function(offset){
            ...
            this.addAnim('fall', 1, [5+offset, 6+offset, 7+offset,8+offset,9+offset]);
            this.addAnim('jump', 0.4, [10+offset,11+offset,12+offset,13+offset,14+offset]);
            this.addAnim('swim',.07, [15+offset,16+offset,17+offset,18+offset,19+offset]);
            this.addAnim('fly',.07, [20]);
        },
        ...
        update: function() {
            ...
            if (this.fly == true){
                ...
                if (ig.input.pressed('switch')) {
                    ...
                    switch (this.weapon) {
                        case(0):
                            this.activeWeapon = "EntityBulletm";
                            break;
                        case(1):
    ...
    EntityBulletm = ig.Entity.extend({
        size: {x: 8, y: 8},
        animSheet: new ig.AnimationSheet( 'media/bulletm.png', 8, 8 ),
        maxVel: {x: 200, y: 0},
    ...
    EntityGrenade = ig.Entity.extend({
        ...
        EntityPunch = ig.Entity.extend({
            size: {x: 8, y: 8},
            animSheet: new ig.AnimationSheet( 'media/punch.png', 8, 8 ),
            maxVel: {x: 200, y: 0},
            type: ig.Entity.TYPE.NONE,
            checkAgainst: ig.Entity.TYPE.B,
            collides: ig.Entity.COLLIDES.PASSIVE,
